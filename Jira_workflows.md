...
| **Not a bug**      | Doesn't affect application functionality or works as designed.                                                                                                                      | Developer / SM                   |
...
| **Low**       | Fixing can be deferred until all higher priority defects are resolved. Often minor.                          |

---

#### 3.🛠️ Required Jira Fields:
- **Issue Type:** Bug
